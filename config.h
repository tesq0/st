...
MouseKey mkeys[] = {
	...
	{ Button4,              CTRL_SHIFT,     zoom,           {.f = +1} },
	{ Button5,              CTRL_SHIFT,     zoom,           {.f = -1} },
};
